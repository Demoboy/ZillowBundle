...
use KMJ\ZillowBundle\Response\CompsResponse;
 ...
 */
class CompsRequest extends Request {

    /**
     * The URL to use when performing the request
     */
    const URL = "http://www.zillow.com/webservice/GetComps.htm";
    ...
    protected function handleResponse(SimpleXMLElement $xml) {
        return new CompsResponse($xml->response->properties->children());
    }
